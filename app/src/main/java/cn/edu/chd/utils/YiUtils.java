...
public class YiUtils {
    ...
    public static String getTempPath() {
        ...
        if (YiUtils.isSDCardAvailable()) {
            ...
            //Log.i("abcd!!11111", "路径：" + path);
            //Log.i("外部：", String.valueOf(Environment.getExternalStorageDirectory()));
            //Log.i("getAbsolutePath:",Environment.getExternalStorageDirectory().getAbsolutePath());
        } else {
            path = Environment.getDataDirectory().getAbsolutePath() + ApplicationValues.Base.TEMP_PATH;
            //Log.i("abcd!!222222", "路径：" + path);
            //Log.i("外部：", String.valueOf(Environment.getDataDirectory()));
            //Log.i("getAbsolutePath:",Environment.getDataDirectory().getAbsolutePath());
        }
        File dir = new File(path);
        if (!dir.exists()) {
            dir.mkdirs();
...
//        try {
//            File a=new File(path+"ZhangQiongtest1.txt");
//            a.createNewFile();
//            Log.i("created!!!","OK!");
//        } catch (IOException e) {
//            e.printStackTrace();
