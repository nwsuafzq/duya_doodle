...
//				if(x>=value || y>=value || z>=value+9.8)
    ...
    private void initComponent() {
        ...
        if (ApplicationValues.Base.TYPE_NORMAL_MODEL.equals(type)) {
            ...
            background_pic = FitTheScreenSizeImage(background_pic, screenWidth, screenHeight);
    ...
    private void initConfiguration() {
        ...
        canvas_width = Integer.parseInt(sp.getString(ApplicationValues.Settings.CANVAS_WIDTH, size.x + ""));
        canvas_height = Integer.parseInt(sp.getString(ApplicationValues.Settings.CANVAS_HEIGHT, size.y + ""));
