...
public class ImageEffect extends Activity implements OnClickListener {
    ...
    private void initComponent() {
        ...
        iv_effect7 = (ImageView) findViewById(R.id.iv_effect7);
        ...
        iv_effect7.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_effect6:
                ...
                iv_show.setImageBitmap(tempBitmap);
                break;
            case R.id.iv_effect7:
                pb_op.setVisibility(View.VISIBLE);
                tv_title.setText(titles[6]);
//                Log.i("IMAGEEFFECT","11");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        tempBitmap = BitmapEffectUtils.mohuEffect(srcBitmap,50,false);
                        Message msg = Message.obtain(mHandler, OK);
                        msg.sendToTarget();
                    }
                }).start();
